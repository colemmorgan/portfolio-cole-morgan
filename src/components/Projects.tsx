...
export default function Projects() {
  return (
    <section className="border-dark-200 border-b py-16">
      ...
      <div className="mt-8 grid grid-cols-12 gap-3">
        ...
        <div className="col-span-4">
          ...
          <p className="text-dark-800 mt-2">
            Mockup editor that allows users to quickly create mockups for social
            media, work, and more. Utilizes webgl for complex effects in a
            single click.
          </p>
